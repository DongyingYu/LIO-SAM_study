...
/*
 * optimizes IMU and lidar odometry factor and estimates IMU bias.
 * This factor graph is reset periodically and guarantees real-time odometry estimation at IMU frequency.
*/
